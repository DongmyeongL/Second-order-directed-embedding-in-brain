...
For a figure-by-figure guide to those CSV files, see `data/statistics_by_figure/README.md` and the machine-readable index `data/statistics_by_figure/statistics_index.csv`.
