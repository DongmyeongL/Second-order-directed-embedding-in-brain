...
- Figure-by-figure statistics guide: `data/statistics_by_figure/README.md`
...
| `data/statistics_by_figure/` | Figure-by-figure guide to statistics tables, plotted-value tables, and supplementary figure cache files. |
...
|---|---|---|
| `outputs/supplementary/figure_supply_0.png` | Empirical and simulated calcium traces, FC matrices, and FC variability comparison | `code/figure_supply_0.py` |
...
| `outputs/supplementary/figure_supply_5.png` | P/SP NULL-In and NULL-Out structural perturbation examples and DCA null-model comparisons | `code/figure_supply_5.py` |
...
| `outputs/supplementary/figure_supply_13.png` | Example community-level transfer-entropy and FC-neighbor analysis | `code/figure_supply_13.py` |
| `outputs/supplementary/figure_supply_14.png` | Zebrafish OMR stimulus-associated FCV modulation | `code/figure_supply_14.py` |
| `outputs/supplementary/figure_supply_15.png` | Layer-wise directed linear model traces and zebrafish example region-pair dynamics | `code/figure_supply_15.py` |
...
`requirements.txt` lists versioned lower bounds for the Python packages used by
...
Panel-level statistics generated by the final figure scripts are stored in `data/final_summary_tables/`.
For a figure-by-figure guide to those CSV files, plotted-value tables, and supplementary figure cache files, see `data/statistics_by_figure/README.md` and the machine-readable index `data/statistics_by_figure/statistics_index.csv`.
Examples include `figure9_stats.csv`, `figure12_stats.csv`, `figure13_stats.csv`, `figure_sc_fc_final_overview_stats.csv`, and the functional-group synthesis tables used by manuscript Fig. 6.
The statistics guide also records supplementary figure inputs. Supplementary Figs. S0, S1, S2, S5, and S10 include explicit CSV statistics or plotted-summary tables; other supplementary figures rely on listed `.npz`, `.npy`, or `.pkl` cache files.
