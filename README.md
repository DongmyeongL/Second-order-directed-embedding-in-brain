...
The statistics guide also records supplementary figure inputs. Several supplementary figures compute simple on-panel statistics directly from listed `.npz`, `.npy`, or `.pkl` cache files rather than storing separate p-value CSV files.
